...
import org.usfirst.frc.team6404.robot.OI;
...
public class DriveCommand extends Command {
	...
	public DriveCommand() {
		...
		enc.setDistancePerPulse((Math.PI*6*2.54)/512);
	}
	...
	protected void execute() {
		Robot.driver_subsystem.driveRobot(OI.stick.getX(), OI.stick.getY());
		SmartDashboard.putNumber("distance", enc.getDistance());
		SmartDashboard.putNumber("pulse", enc.getRaw());
	}
